...
<asp:Content ID="HeroContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-2">
                <asp:Button runat="server" Text="+" OnCommand="UpdateStat" CommandArgument="Strength" />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                <asp:Button runat="server" Text="+" OnCommand="UpdateStat" CommandArgument="Defence" />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                <asp:Button runat="server" Text="+" OnCommand="UpdateStat" CommandArgument="Agility" />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                <asp:Button runat="server" Text="+" OnCommand="UpdateStat" CommandArgument="Stamina" />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                <asp:Button runat="server" Text="+" OnCommand="UpdateStat" CommandArgument="Charisma" />
            </div>
        </div>
        <br />
        <div class="row">
